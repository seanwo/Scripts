...
; Snap to full screen (Win + Up)
; 1 rows, 1 column, first row, first column
#Up::SnapActiveWindowGrid(1, 1, 1, 1)

; Snap to top half of screen (Ctl + Alt + Up)
; 2 rows, 1 column, first row, first column
^!Up::SnapActiveWindowGrid(2, 1, 1, 1)

; Snap to bottom half of screen (Ctl + Alt + Down)
; 2 rows, 1 columns, second row, first column
^!Down::SnapActiveWindowGrid(2, 1, 2, 1)

; Snap to left half of screen (Alt + Win + Left)
; 1 row, 2 columns, first row, first column
!#Left::SnapActiveWindowGrid(1, 2, 1, 1)

; Snap to right half of screen (Alt + Win + Right)
; 1 row, 2 columns, first row, second column
!#Right::SnapActiveWindowGrid(1, 2, 1, 2)

; Snap to top left quarter of screen (Shift + Ctl + Win + Left)
; 2 rows, 2 column, first row, first column
+^#Left::SnapActiveWindowGrid(2, 2, 1, 1)

; Snap to top right quarter of screen (Shift + Ctl + Win + Right)
; 2 rows, 2 column, first row, second column
+^#Right::SnapActiveWindowGrid(2, 2, 1, 2)

; Snap to bottom left quarter of screen (Ctl + Win + Left)
; 2 rows, 2 column, second row, first column
^#Left::SnapActiveWindowGrid(2, 2, 2, 1)

; Snap to bottom right quarter of screen (Ctl + Win + Right)
; 2 rows, 2 column, second row, second column
^#Right::SnapActiveWindowGrid(2, 2, 2, 2)
